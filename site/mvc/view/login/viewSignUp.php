            ...
            <div class="border p-3 mb-3 rounded bg-light">
                ...
                <form method="POST" action="/login/signUp">
                    <div class="form-floating mb-3 mt-3">
                        <input required id="pseudo" name="pseudo" class="pseudo form-control" type="text" placeholder="a">
                        <label for="pseudo" class="form-label">Pseudo</label>
                        <div id='pseudoToolTip' class="text-danger error form-text">This username is already taken.</div>
                    </div>

                    <div class="form-floating mb-3 mt-3">
                        <input required name="email" id="email" class="emailInput form-control" type="email" placeholder="a">
                        <label for="email" class="form-label">Email</label>
                        <div id='emailToolTip' class="text-danger error form-text">Please enter a valid email address.</div>
                    </div>
                    <div class="mb-3 form-floating">
                        <input required name="password" id="password" class="passwordInput form-control" type="password" placeholder="password">
                    ...
                    <div class="mb-3 form-floating">
                        <input required name="password2" id="password2" class="confirmPassword form-control" type="password" placeholder="password">
